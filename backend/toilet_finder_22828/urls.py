"""toilet_finder_22828 URL Configuration
...
admin.site.site_header = "toilet finder"
admin.site.site_title = "toilet finder Admin Portal"
admin.site.index_title = "toilet finder Admin"

# swagger
api_info = openapi.Info(
    title="toilet finder API",
    default_version="v1",
    description="API documentation for toilet finder App",
)
